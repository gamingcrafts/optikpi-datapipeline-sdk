...
public class AccountEvent {
    ...
    private String eventCategory = "Account";
    ...
    @Pattern(regexp = "desktop|mobile|tablet|app", message = "device must be one of: desktop, mobile, tablet, app")
    @JsonProperty("device")
    ...
    public AccountEvent(String accountId, String workspaceId, String userId, String eventName, String eventId, String eventTime) {
