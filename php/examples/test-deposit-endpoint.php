...
echo "✅ Deposit event validated successfully!\n";

// Test deposit endpoint
function testDepositEndpoint($sdk, $deposit, $API_BASE_URL, $ACCOUNT_ID, $WORKSPACE_ID, $AUTH_TOKEN) {
    try {
        echo "🚀 Testing Deposit Events Endpoint\n";
        echo "==================================\n";
        ...
        echo "Deposit Event Data: " . json_encode($deposit->toArray(), JSON_PRETTY_PRINT) . "\n";

        // Make the API call using SDK
        $startTime = microtime(true) * 1000;
        $result = $sdk->sendDepositEvent($deposit);
...
if (php_sapi_name() === 'cli') {
    testDepositEndpoint($sdk, $deposit, $API_BASE_URL, $ACCOUNT_ID, $WORKSPACE_ID, $AUTH_TOKEN);
}
