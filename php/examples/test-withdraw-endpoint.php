...
echo "✅ Withdraw event validated successfully!\n";

// Test withdraw endpoint
function testWithdrawEndpoint($sdk, $withdraw, $API_BASE_URL, $ACCOUNT_ID, $WORKSPACE_ID, $AUTH_TOKEN) {
    try {
        echo "🚀 Testing Withdraw Events Endpoint\n";
        echo "===================================\n";
        ...
        echo "Withdraw Event Data: " . json_encode($withdraw->toArray(), JSON_PRETTY_PRINT) . "\n";

        // Make the API call using SDK
        $startTime = microtime(true) * 1000;
        $result = $sdk->sendWithdrawEvent($withdraw);
...
if (php_sapi_name() === 'cli') {
    testWithdrawEndpoint($sdk, $withdraw, $API_BASE_URL, $ACCOUNT_ID, $WORKSPACE_ID, $AUTH_TOKEN);
}
