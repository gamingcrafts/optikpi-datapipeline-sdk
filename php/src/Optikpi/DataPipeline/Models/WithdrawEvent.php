...
class WithdrawEvent
{
     ...
     * Constructor
     *
     * @param array $data Withdraw event data
     */
    ...
    public function validate(): array
    {
        ...
        if (!empty($this->event_category) && $this->event_category !== 'Withdraw') {
            $errors[] = 'event_category must be "Withdraw" for withdraw events';
        }
    ...
    /**
     * Creates a WithdrawEvent instance from array
     *
     * @param array $data Plain array data
     * @return WithdrawEvent New WithdrawEvent instance
     */
